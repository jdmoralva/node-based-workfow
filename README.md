...
- chat IA con modo automatico segun intencion
...
La siguiente fase natural es implementar la estructura de aplicacion real en `apps/web` y `apps/api`, usando `docs/SPEC.md` como guia tecnica principal.
